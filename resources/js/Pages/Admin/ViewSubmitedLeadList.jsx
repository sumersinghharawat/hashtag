                ...
                <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div className="flex flex-row">
                        <div className="flex flex-col justify-between w-full p-6 border-r-2 border-gray-200">
                            <div className="mb-10">
                                <h2 className="text-4xl">Customer Leads</h2>
                            </div>
                            <div className="mb-10">
                                <div className="relative overflow-x-auto">
                                    <table className="w-full text-sm text-left text-gray-500">
                                        ...
                                        <tbody>
                                        {companyleads!=null?(companyleads.map((element,index)=>{return <tr key={index} className="bg-white border-b">
                                                <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                                    {element.name?element.name:'pending'}
                                                </th>
                                                <td className="px-6 py-4">
                                                    {element.founders.length?element.founders.length:'pending'}
                                                </td>
                                                <td className="px-6 py-4">
                                                    <span className="text-gray-500">{(element.status==0 || element.status==null)?'Payment Due':''}</span>
                                                </td>
                                                <td className="px-6 py-4">
