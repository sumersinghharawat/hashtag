        ...
        <div className="bg-primary" id='process'>
            <div className="container flex flex-row flex-wrap justify-between h-full mx-auto md:items-center md:flex-col md:py-36 py-14">
                ...
                <div className='relative flex-col justify-between hidden w-full overflow-hidden md:flex-row md:flex md:justify-center md:w-full process-lines' data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div className='flex flex-col items-center justify-center w-3/12 process'>
                ...
                <div className="flex flex-col justify-center w-full gap-4 md:flex-row md:w-full steps md:gap-0 ">
                    <div className="w-4/5 py-4 mx-auto md:py-8 md:mx-12 md:w-3/12 md:m-0 step-1 rounded-3xl" data-aos="fade-up" data-aos-delay="500">
                        <h4 className="mt-0 mb-2 text-[32px] font-manrope font-medium">Create Your Account</h4>
                        <p className="font-manrope ">Sign up quickly and easily to begin your business journey in the UAE.</p>
                    </div>
                    <div className="w-4/5 py-4 mx-auto md:py-8 md:mx-12 md:w-3/12 md:m-0 step-2 rounded-3xl" data-aos="fade-up" data-aos-delay="500">
                        <h4 className="mt-0 mb-2 text-[32px] font-manrope font-medium">Enter Basic Information</h4>
                        <p className="font-manrope ">Provide basic information about your company.</p>
                    </div>
                    <div className="w-4/5 py-4 mx-auto md:py-8 md:mx-12 md:w-3/12 md:m-0 step-3 rounded-3xl" data-aos="fade-up" data-aos-delay="500">
                        <h4 className="mt-0 mb-2 text-[32px] font-manrope font-medium">Upload Document</h4>
                        <p className="font-manrope ">Easily upload the required documents to your dashboard</p>
                    </div>
                    <div className="w-4/5 py-4 mx-auto md:py-8 md:mx-12 md:w-3/12 md:m-0 step-4 rounded-3xl" data-aos="fade-up" data-aos-delay="500">
                        <h4 className="mt-0 mb-2 text-[32px] font-manrope font-medium">Trade License Issued</h4>
                        <p className="font-manrope ">Sit back while we file the legal paperwork with UAE authorities.</p>
                    </div>
                </div>
            </div>
        </div>
