...
export const DragAndDropBox = ({ company_info, document_type, uploaded_document_file, uploaded_document_file_name, founder_id,  updatedocument, upload_status=true }) => {
    ...
    return (
        ...
        <div>
            ...
            <div
                ...
                onDragOver={(e)=>upload_status?handleDragOver(e):{}}
                onDrop={(e)=>upload_status?handleDrop(e):{}}
                onClick={(e)=>upload_status?handleFileClick(e):{}}
            >
                <input
                    type="file"
